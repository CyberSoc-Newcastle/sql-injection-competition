...
GRANT SELECT, SHOW VIEW ON boat_club.* TO 'readonly'@'localhost';
FLUSH PRIVILEGES;
...
CREATE USER IF NOT EXISTS 'readonly2'@'localhost' IDENTIFIED BY 'readonly2';
GRANT SELECT, SHOW VIEW ON geordie_boat_rentals_ltd.* TO 'readonly2'@'localhost';
FLUSH PRIVILEGES;
